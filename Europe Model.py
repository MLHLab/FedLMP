...
train_data_europe = pd.read_csv(io.BytesIO(uploaded['train_data_europe.csv']), encoding='unicode_escape')
print(df)
...
test_data_europe = pd.read_csv(io.BytesIO(uploaded['test_data_europe.csv']), encoding='unicode_escape')
print(df)
...
index_file_path = '/content/drive/MyDrive/Vector/europe_vector.index'
...
# Load and run with Central for Europe Data
...
# Load and run with Asia for Europe Data
...
# Load and run with America for Europe Data
